package com.huanli233.particle_customizer.core.component;
...
public enum ParticleType {
    ...
    ParticleType(String particleName, int particleId, boolean shouldIgnoreRange, int argumentCount) {
    ...
    ParticleType(String particleName, int particleId, boolean shouldIgnoreRange) {
    ...
    public static ParticleType getParticleFromId(int id) {
        return (ParticleType) PARTICLES.get(id);
    }
    ...
    static {
        ...
        for(ParticleType type : values()) {
            ...
            if (!type.getParticleName().endsWith("_")) {
